...
Try to color points by veg type (`mdat$co_dominant_species1`)

```{r plot_slr_ci_lmm_veg, fig.width = 7, fig.height = 6, eval = enough_dat}
# put veg type into the data frame
...
out_file <- here::here("R_output", "figures", "summary_plots", "summary_plot_vegcolors.png")
ggsave(out_file)
```
