...
my_plot()
my_plot(plot_type = 3)
my_plot(color_by_veg = TRUE)
my_plot(plot_type = 4, color_by_veg = TRUE)
my_plot(plot_type = 3, color_by_veg = TRUE)
```
...
if(sum(is.na(mdat$numerical_order)) + sum(is.na(mdat$user_friendly_set_name)) == 0){
  ...
  p <- plot_rate_comps(data = lmm_out_ordered, 
                plot_type = 3, 
