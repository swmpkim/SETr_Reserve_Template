...
# add slr
# first figure out where the line should be
# run it through the first 0 in... each... panel?
# want it to go through the first point on the graph
# and have the slr slope
