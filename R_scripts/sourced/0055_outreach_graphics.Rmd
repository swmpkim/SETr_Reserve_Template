...
```{r, out.width = '10%', fig.align = 'center', fig.cap = 'example of a SET; pin heights above the horizontal arm are a proxy for the shape of the marsh surface. Figure from Lynch et al. 2015'}
