...
We start by reading in the long SET measurement dataset, converted from other formats by earlier SETr scripts. Pin heights have also been converted to mm if they were previously in cm.  
