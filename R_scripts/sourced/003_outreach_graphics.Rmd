...
The "Sentinel Site Application 1" (SSAM-1) module of the NERR Sentinel Site Program integrates System-Wide Monitoring Program (SWMP) water level and vegetation data with elevation measurements, for the purpose of assessing the impacts of sea level change on coastal marsh habitat. Surface Elevation Table (SET) technology, a means of measuring height of the marsh substrate, is currently an elective but widely implemented component of SSAM-1. In this project, previously acquired NERRS SET data is analyzed to answer the question – are marsh surfaces keeping pace with sea level rise? Note that this is an analysis looking back through time; it is not a forecasting tool.
...
Because tidal wetlands are so important to coastal areas - they provide wildlife habitat, including nursery habitat for commercial and recreational fish species, recreational areas, and flood protection - we especially want to know if the surface is growing quickly enough to keep up with sea level rise.  
